export default function Login() {
	return (
		<div className="grid grid-cols-2 h-screen bg-gray-400 ">
			<section className="space-y-6 bg-slate-500 h-full flex flex-col justify-center p-6 ">
			...
			<section className="flex justify-center items-center bg-black p-6">
				<form className="flex  items-center justify-center  w-full h-full" action="" method="post">
					<div className="flex flex-col w-full m-5 space-y-4 ">
						...
						<button type="submit" className="mt-4 bg-slate-600 text-white rounded-xl p-2">
							Sign Up
						</button>
					</div>
				</form>
